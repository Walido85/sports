        ...
        try:
            ...
            standings = await page.evaluate('''() => {
                ...
                for (const row of rows) {
                    ...
                    const played   = document.querySelector(`div[data-id="${teamId}_lg-cl_played"]`)?.innerText?.trim() || "0";
                    const wins     = document.querySelector(`div[data-id="${teamId}_lg-cl_wins"]`)?.innerText?.trim() || "0";
                    const draws    = document.querySelector(`div[data-id="${teamId}_lg-cl_draws"]`)?.innerText?.trim() || "0";
                    const losses   = document.querySelector(`div[data-id="${teamId}_lg-cl_losses"]`)?.innerText?.trim() || "0";
                    const gf       = document.querySelector(`div[data-id="${teamId}_lg-cl_goalsFor"]`)?.innerText?.trim() || "0";
                    const ga       = document.querySelector(`div[data-id="${teamId}_lg-cl_goalsAgainst"]`)?.innerText?.trim() || "0";
                    const gd       = document.querySelector(`div[data-id="${teamId}_lg-cl_goalsDiff"]`)?.innerText?.trim() || "0";
                    const pts      = document.querySelector(`div[data-id="${teamId}_lg-cl_points"]`)?.innerText?.trim() || "0";
